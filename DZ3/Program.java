public class Program {
    ...
    //  3. Расширить абстрактный класс «Car», добавить метод: подметать улицу. Создать конкретный автомобиль путём наследования 
    ...
    //  6. Создать конкретный автомобиль путём наследования класса «Car», определить метод «движение» - «полёт». Провести проверку
    //      принципа LSP.
    ...
    public static void main(String[] args) {
        ...
        Harwester harwester = new Harwester("A", "B", Color.red);

        RefuelingStation refuelingStation = new RefuelingStation();

        harwester.setRefuelingStation(refuelingStation);

        harwester.fuel(FuelType.Diesel);

        // Д/З Завести автомобили на мойку и сделать чистки, а также посчитать ТО

        WipingStation wipingStation = new WipingStation();

        harwester.setWipingStation(wipingStation);

        harwester.wipHeadlights();
        harwester.wipWindshield();

        System.out.printf("Сумма ТО = %.1f", calculateMaintenance(harwester));
        System.out.println();
        System.out.println("---------------------");
        
        SportCar sportCar = new SportCar("AA", "BB", Color.black);
        ...
        WipingStationV2 wipingStation2 = new WipingStationV2();

        sportCar.setWipingStation(wipingStation2);

        sportCar.wipMirrors();

        System.out.printf("Сумма ТО = %.1f", calculateMaintenance(sportCar));
        System.out.println();
        System.out.println("---------------------");
